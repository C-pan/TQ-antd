...
import { Breadcrumb, Form, Icon, Input, Row, Col, Button, Card, Message } from 'antd';
        ...
        return (
            <div className="content-box"> 
                <Breadcrumb className="header-Breadcrumb">
                    ...
                    <Breadcrumb.Item> 银行卡提现</Breadcrumb.Item>
                </Breadcrumb>
                {/* 创建密码  */}
                <CreateBusinessModal
        ...
        render() {
            ...
            return (
                <div>
                    ...
                    <Form onSubmit={this.handleSubmit} style={{ padding:"20px 0px 10px"}}>                             
                            ...
                            >
                                ...
                                <Input type="text" style={{ width: '200px' }} placeholder="请输入持卡人姓名" />
                                    )}
                            </FormItem>
                            <FormItem label="银行名称"
                                {...formItemLayout}
                            >
                                ...
                                rules: [{ required: true, message: '请输入银行名称!' }],
                                    ...
                                    <Input type="text" style={{ width: '200px' }} placeholder="比如：中国银行" />
                                    )}
                            </FormItem>
                            <FormItem label="银行卡号"
                                {...formItemLayout}
                            >
                                ...
                                <Input type="text" style={{ width: '200px' }} placeholder="请输入银行卡号"  />
                                    )}
                            </FormItem>
                            <FormItem label="提现密码"
                                {...formItemLayout}
